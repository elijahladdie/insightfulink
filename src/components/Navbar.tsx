...
const Navbar = () => {
  ...
  return (
    <div className="w-screen  bg-white overflow-hidden">
        ...
        <div className=" flex lg:gap-20 gap-3 items-center lg:text-lg text-sm">
          {!user ? (
            <ul className=" flex gap-3">
             ...
             hover:text-custom-tomato ${
               activeNav === 1 ? "text-custom-tomato" : "text-black"
             }`}
              >
                <Link to="/">Home </Link>
              </li>
              ...
              <li
                ...
                className={`border-r-2 border-custom-gray px-3
             hover:text-custom-tomato ${
               activeNav === 2 ? "text-custom-tomato" : "text-black"
             }`}
              >
              ...
              <li
                ...
                className={`border-r-2 border-custom-gray px-3
             hover:text-custom-tomato ${
               activeNav === 3 ? "text-custom-tomato" : "text-black"
             }`}
              >
              ...
              <li
                ...
                className={`border-r-2 border-custom-gray px-3
             hover:text-custom-tomato ${
               activeNav === 4 ? "text-custom-tomato" : "text-black"
             }`}
              >
             ...
             hover:text-custom-tomato ${
               activeNav === 5 ? "text-custom-tomato" : "text-black"
             }`}
              >
          ...
          <ul className="flex lg:gap-2 gap-1">
            <li
             ...
             hover:text-custom-tomato ${
               activeNav === 6 ? "text-custom-tomato" : "text-black"
             }`}
            >
              {!access_info ? (
      ...
      <div
        className={` transition overflow-hidden duration-300 ease-linear lg:hidden md:hidden ${
